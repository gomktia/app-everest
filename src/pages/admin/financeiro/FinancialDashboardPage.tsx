...
export default function FinancialDashboardPage() {
  ...
  const kpis = [
    ...
    },
    {
      ...
      bg: 'bg-yellow-100 dark:bg-yellow-950/50 border-yellow-300 dark:border-yellow-800',
    ...
    },
    {
      ...
      bg: 'bg-purple-100 dark:bg-purple-950/50 border-purple-300 dark:border-purple-800',
    ...
    },
    {
      ...
      bg: 'bg-teal-100 dark:bg-teal-950/50 border-teal-300 dark:border-teal-800',
    ...
    },
    {
      ...
      deltaColor: '',
      arrow: '',
      bg: 'bg-orange-100 dark:bg-orange-950/50 border-orange-300 dark:border-orange-800',
