          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-xl bg-blue-100 dark:bg-blue-950/50 border border-blue-300 dark:border-blue-800">
              ...
              <Badge variant="outline" className="bg-blue-100 dark:bg-blue-950/50 border-blue-300 dark:border-blue-800 text-blue-600">
                    ...
                    <Card className="border-border shadow-sm text-center py-12">
                      <CardContent className="p-5">
                        <div className="max-w-md mx-auto">
                          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-blue-100 dark:bg-blue-950/50 flex items-center justify-center">
                    ...
                    <Card className="border-border shadow-sm">
                      <CardContent className="p-5">
                        <div className="space-y-6">
                          ...
                          <div className="p-4 rounded-xl bg-green-100 dark:bg-green-950/50 border border-green-300 dark:border-green-800">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  <Badge variant="outline" className="bg-green-100 dark:bg-green-950/50 border-green-300 dark:border-green-800 text-green-700">
                                    Dashboard
                                  </Badge>
                                  <Badge variant="outline" className="bg-green-100 dark:bg-green-950/50 border-green-300 dark:border-green-800 text-green-700">
                                    Calendario
                          ...
                          {/* Info Box */}
                          <div className="p-4 rounded-xl bg-blue-100 dark:bg-blue-950/50 border border-blue-300 dark:border-blue-800">
                            <div className="flex items-start gap-3">
