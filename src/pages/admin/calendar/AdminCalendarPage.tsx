...
const eventConfig = {
  LIVE_CLASS: {
    ...
    bg: 'bg-emerald-100 dark:bg-emerald-950/50 border-emerald-300 dark:border-emerald-800',
    dot: 'bg-emerald-1000',
    badge: 'bg-emerald-100 dark:bg-emerald-950/50 text-emerald-600 border-emerald-300 dark:border-emerald-800 dark:text-emerald-400',
  },
  SIMULATION: {
    label: 'Simulado',
    icon: Target,
    ...
    dot: 'bg-blue-1000',
    badge: 'bg-blue-100 dark:bg-blue-950/50 text-blue-600 border-blue-300 dark:border-blue-800 dark:text-blue-400',
  },
  ESSAY_DEADLINE: {
    label: 'Redação',
    icon: PenTool,
    color: 'text-rose-600 dark:text-rose-400',
    bg: 'bg-rose-100 dark:bg-rose-950/50 border-rose-300 dark:border-rose-800',
    dot: 'bg-rose-1000',
    badge: 'bg-rose-100 dark:bg-rose-950/50 text-rose-600 border-rose-300 dark:border-rose-800 dark:text-rose-400',
  },
  GENERAL: {
    label: 'Geral',
    icon: Info,
    color: 'text-slate-600 dark:text-slate-400',
    bg: 'bg-slate-100 dark:bg-slate-950/50 border-slate-300 dark:border-slate-800',
    dot: 'bg-slate-400',
    badge: 'bg-slate-100 dark:bg-slate-950/50 text-slate-600 border-slate-300 dark:border-slate-800 dark:text-slate-400',
  },
}
