      ...
      <Card className="border-border shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-3 rounded-lg bg-green-100 dark:bg-green-950/50 border border-green-300 dark:border-green-800">
              <p className="text-xl font-bold text-green-600">{((session.correct / session.totalCards) * 100).toFixed(1)}%</p>
              <p className="text-xs text-muted-foreground">Taxa de Acerto</p>
            </div>
            <div className="text-center p-3 rounded-lg bg-blue-100 dark:bg-blue-950/50 border border-blue-300 dark:border-blue-800">
                  ...
                  <AccordionTrigger className="hover:no-underline">
                    <div className="flex items-center gap-3 text-left">
                      <div className={cn(
                        ...
                        card.userAnswer === 'correct' ? 'bg-green-100 dark:bg-green-950/50 text-green-500' : 'bg-red-100 dark:bg-red-950/50 text-red-500',
                      )}>
                        ...
                        <Badge
                          ...
                          className={cn(
                            ...
                            card.userAnswer === 'correct'
                              ...
                              : 'bg-red-100 dark:bg-red-950/50 text-red-600 border-red-300 dark:border-red-800',
                          )}
                        >
