    ...
    return (
      <Badge
        ...
        className={cn(
          ...
          isCritical
            ? 'bg-red-100 dark:bg-red-950/50 text-red-600 border-red-300 dark:text-red-400 dark:border-red-700 animate-pulse'
            : isUrgent
              ? 'bg-orange-100 dark:bg-orange-950/50 text-orange-600 border-orange-300 dark:text-orange-400 dark:border-orange-700'
              : 'bg-amber-100 dark:bg-amber-950/50 text-amber-600 border-amber-300 dark:text-amber-400 dark:border-amber-700',
          className
        )}
