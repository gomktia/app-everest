...
> = {
  ...
  emerald: {
    ...
    l1Bg: 'bg-emerald-50 dark:bg-emerald-950/50',
...
> = {
  concept: {
    ...
    label: 'Conceito',
    badgeClass: 'bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-800/50 dark:text-blue-200 dark:border-blue-700',
    cardBg: 'bg-blue-50/80 dark:bg-blue-950/50',
    borderClass: 'border-l-blue-500 dark:border-l-blue-400',
  },
  example: {
    icon: <Code className="w-3.5 h-3.5" />,
    label: 'Exemplo',
    badgeClass: 'bg-green-100 text-green-700 border-green-200 dark:bg-green-800/50 dark:text-green-200 dark:border-green-700',
    cardBg: 'bg-green-50/80 dark:bg-green-950/50',
    borderClass: 'border-l-green-500 dark:border-l-green-400',
  },
  exception: {
    icon: <AlertTriangle className="w-3.5 h-3.5" />,
    label: 'Exceção',
    badgeClass: 'bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-800/50 dark:text-orange-200 dark:border-orange-700',
    cardBg: 'bg-orange-50/80 dark:bg-orange-950/50',
    borderClass: 'border-l-orange-500 dark:border-l-orange-400',
  },
  tip: {
    icon: <Lightbulb className="w-3.5 h-3.5" />,
    label: 'Dica',
    badgeClass: 'bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-800/50 dark:text-purple-200 dark:border-purple-700',
    cardBg: 'bg-purple-50/80 dark:bg-purple-950/50',
    borderClass: 'border-l-purple-500 dark:border-l-purple-400',
  },
  rule: {
    icon: <Scale className="w-3.5 h-3.5" />,
    label: 'Regra',
    badgeClass: 'bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-700/50 dark:text-slate-200 dark:border-slate-600',
    cardBg: 'bg-slate-50/80 dark:bg-slate-900/50',
    borderClass: 'border-l-slate-500 dark:border-l-slate-400',
  },
  warning: {
    icon: <ShieldAlert className="w-3.5 h-3.5" />,
    label: 'Atenção',
    badgeClass: 'bg-red-100 text-red-700 border-red-200 dark:bg-red-800/50 dark:text-red-200 dark:border-red-700',
    cardBg: 'bg-red-50/80 dark:bg-red-950/50',
